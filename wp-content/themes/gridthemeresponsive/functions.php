...
if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
  ...
  add_image_size('home-post',228,228,true);
  add_image_size('home-post-iphone',300,300,true);
  add_image_size('home-medium',299,299,true);
  add_image_size('home-small',224,224,true);
